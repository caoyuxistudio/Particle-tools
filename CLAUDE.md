...
- 控制台 harness `public/__ai-test.js`，当前基线 **295/295**（含 `collisionReport` 8、`trailReport` 9、`stretchReport` 9、`aoReport` 7、`shadowReport` 10、`report` 30、`standaloneReport` 20、`touchReport` 9、`parallaxReport` 19、`videoReport` 30、`gizmoReport` 12、`playerReport` 41、`presentReport` 33、`frameReport` 24）
